...
--
-- Host: localhost:3306
-- Generation Time: Feb 17, 2022 at 01:13 PM
...
SET autocommit=0;
INSERT INTO `accounting` VALUES (1,100.00,'lab',13,1,0,'2022-02-17 12:02:58'),(2,100.00,'lab',8,1,0,'2022-02-17 12:02:58'),(3,100.00,'lab',14,1,0,'2022-02-17 12:02:58');
/*!40000 ALTER TABLE `accounting` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `accounting` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `labrequests` VALUES (1,1,13,'620e39727fe61',1,'2022-02-17 12:02:58'),(2,1,8,'620e3972a10c6',1,'2022-02-17 12:02:58'),(3,1,14,'620e3972c31b1',0,'2022-02-17 12:02:58');
/*!40000 ALTER TABLE `labrequests` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `labrequests` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `results` VALUES (1,13,'15',255,21,1,1,1,NULL,'2022-02-17 12:03:30'),(2,8,'Positive',NULL,NULL,1,2,1,NULL,'2022-02-17 12:03:55');
/*!40000 ALTER TABLE `results` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `results` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `service_request` VALUES (1,1,'','2022-02-17 12:02:45');
/*!40000 ALTER TABLE `service_request` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `service_request` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `users` VALUES (1,'mod47387@yahoo.com','$2y$10$QaAzFGYmnbBsHfbwydSK1ug6eaW2/YXJcx312o6feuhGOpT6CblyC','mod47387',0,1,1,1,1622394801,1645099311,1),(2,'mod47387@gmail.com','$2y$10$A0eVdYzCCKpi8b9qobbe1ulZBwiPcQ18Wle.LtJMTG1jRp7EIyHHm','moh123',0,1,1,1,1622395297,1622411499,3),(3,'lab@klab.com','$2y$10$09hpmv1xZat6lD40k51G/OkUAckJyNhtEzbEitFMRnbL4jn7tAxyy','Lab Tech',0,1,1,2048,1622411580,1642532720,6),(4,'acc@klab.com','$2y$10$OBkXCqnBPxVJGNZfk1qfBOp6ydDGUaxNHhPTvIQyMpHU4BWBjcG9W','accountant',0,1,1,8192,1622840563,1638034592,2);
...
-- Dump completed on: Thu, 17 Feb 2022 13:56:13 +0100
