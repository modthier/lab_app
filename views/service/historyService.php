 ...
 <div class="app-page-title">
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <a href="?view=indexService" class="btn btn-danger">Back</a> 
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form action="" method="get">
          <input type="hidden" name="view" value="searchHistoryService">
      ...
      <div class="main-card mb-3 card">
      	<div class="card-header">
      		...
      		<div class="btn-actions-pane-right">
      			<a href="?view=showHistoryService&service_id=<?php echo $row['id']; ?>" class="btn btn-primary">Details</a>
