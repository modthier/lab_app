...
?>
<?php if ($type['checkup_value'] == 'selectionApp') {
	echo "yes";
} ?>
			...
			<?php case 'number': ?>
				<div class='form-row'>
					 <div class='col-md-2'>
						<div class='position-relative form-group'>
						  <label><?php echo $test_name; ?></label>
						  <input type='number' step="0.1" name='result' class='form-control' required>
						</div>
					 </div>
		...
		<?php case 'number': ?> 	
		 ...
		 <div class='form-row'>
					 <div class='col-md-2'>
						<div class='position-relative form-group'>
						  <label><?php echo $row['checkup_name']; ?></label>
						  <input type='number' step="0.1" name='result-<?php echo $row['test_id'];?>' class='form-control' required>
						</div>
					 </div>
